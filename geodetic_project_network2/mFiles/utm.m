...
x=N*(Lambda*cos(Fi)+(Lambda^3*(cos(Fi))^3/6)*(1-t^2+k^2)+(Lambda^5*(cos(Fi))^5/120)*(5-18*t^2+t^4+14*k^2-58*t^2*k^2+13*k^4+4*k^6-64*k^4*t^2-24*k^6*t^2)...
